            ...
            <div class="page-wrapper">
                ...
                <div class="page-breadcrumb bg-white">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Danh sách các bài kiểm tra</h4>
                        </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <div class="d-md-flex">
                                <ol class="breadcrumb ms-auto">
                                    <li><a href="../detail-chapter-lecture?chapterID=${lesson.getChapter().getChapterID()}" class="fw-normal">Danh sách các bài giảng</a></li>
                                </ol>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                <h3 class="box-title">Các bài kiểm tra</h3>
                                <button class="btn d-grid btn-info text-white"><a href="../lecture/quiz_add?lessonID=${lesson.getLessonID()}" style="text-decoration: none;color: White;">Thêm bài kiểm tra mới</a></button>
                                <div class="table-responsive">
                                    <table class="table text-nowrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">STT</th>
                                                <th class="border-top-0">Bài kiểm tra</th>
                                                <th class="border-top-0">Thuộc bài giảng</th>
                                                <th class="border-top-0">Details</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${list_quiz}" var="q" varStatus="status">
                                            <tr>
                                                <td>${status.count}</td>
                                                <td>Quiz ${status.count}</td>
                                                <td>${q.getLesson().getTitle()}</td>
                                                <td><button class="btn d-grid btn-info text-white"><a href="../lecture/quiz_detail?quizID=${q.getQuizID()}" style="text-decoration: none;color: white;">Details</a></button></td>
                                            </tr>
                                        </c:forEach>
