<%-- 
    Document   : lecture-profile
    Created on : Mar 9, 2022, 1:58:47 PM
    Author     : asus
--%>
        ...
        <div class="page-breadcrumb bg-white">
          <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
              <h4 class="page-title">Profile Lecture</h4>
            </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                  ...
                  <div class="overlay-box">
                    <div class="user-content">
                      <a href="javascript:void(0)">
                        <img src="${pageContext.request.contextPath}/images/${lec.lecture.image}"
                             class="thumb-lg img-circle" alt="img">
                      </a>
                      <h4 class="text-white mt-2">${lec .username}</h4>
            ...
            <div class="col-lg-8 col-xlg-9 col-md-12">
              <div class="card">
                <div class="card-body">
                  <form action="lecture-profile?lectureID=${lec.lecture.lectureID}" method="POST" class="form-horizontal form-material">
                    <div class="form-group mb-4">
                      <label class="col-md-12 p-0">Full Name</label>
                      <div class="col-md-12 border-bottom p-0">
                        <input placeholder="Johnathan Doe" value="${lec.lecture.fullname}"
                    ...
                    <div class="form-group mb-4">
                      ...
                      <div class="col-md-12 border-bottom p-0">
                        ...
                        <input type="radio" 
                               value="0" ${lec.lecture.gender? "":"checked"}
                    ...
                    <div class="form-group mb-4">
                      ...
                      <div class="col-md-12 border-bottom p-0">
                        <input  placeholder="feryt@fpt.edu.vn" 
                               value="${lec.lecture.email}"
