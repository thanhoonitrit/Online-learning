                ...
                <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                    ...
                    <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                        <ul class="navbar-nav ms-auto d-flex align-items-center">
                            <li class=" in">
                                <form role="search" action="../lecture/course_search" method="POST" class="app-search d-none d-md-block me-3">
                                    <input type="text" placeholder="Tìm..." class="form-control mt-0" name="txt_search">
                                    <input type="date" class="form-control mt-0" name="date">
                                    <select name="category">
                                        <option value="-1" ${category_id == -1 ? "selected" : ""}>Chọn thể loại của khóa học</option>
                                        <c:forEach items="${list_category}" var="c">
                                            <option value="${c.getCategoryID()}" ${category_id == c.getCategoryID() ? "selected" : ""}>${c.getCategoryName()}</option>
                                        </c:forEach>
                                    </select>
                            ...
                            <li>
                                <a class="profile-pic" href="#">
                                    <img src="../images/lectures/${lecture.getImage()}" alt="user-img" width="36"
                                         class="img-circle"><span class="text-white font-medium">${lecture.getFullname()} </span>
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                <h3 class="box-title">Các khóa học</h3>
                                <button class="btn d-grid btn-info text-white"><a href="../course/add" style="text-decoration: none;color: White;">Thêm khóa học mới</a></button>
                                <div class="table-responsive">
                                    <table class="table text-nowrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">STT</th>
                                                <th class="border-top-0">Tên khóa học</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="l" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>${l.getAuthor().getFullname()}</td>
                                                    <td>${l.getCategory().getCategoryName()}</td>
                                                    <td><button class="btn d-grid btn-info text-white"><a href="../lecture/course_detail?courseID=${l.getCourseID()}" style="text-decoration: none;color: white;">Details</a></button></td>
                                                    <td><button class="btn d-grid btn-warning text-white"><a href="../CourseUpdateController?courseID=${l.getCourseID()}">Edit</a></button></td>
<!--                                                    <td><button class="btn d-grid btn-danger text-white"><a href="../lecture/delete_course?courseID=${l.getCourseID()}" style="text-decoration: none;color: white;">Delete</a></button></td>-->
                                                </tr>
                                            </c:forEach>
